    ...
    <View style={{ flex: 1, justifyContent: "center", alignItems: "center" }}>
      ...
      <View style={{ marginHorizontal: 40, marginTop: 20 }}>
        ...
        <Text style={styles.submitText}>
          Your request has been submitted successfully. You will be notified
          soon.
        </Text>
        <Button
          title="Close"
...
function Apply({ navigation, route }) {
        ...
        case "Daily": // with interest of 5.5%
          ...
          for (let day = 1; day <= 100; day++) {
            ...
            nextPaymentDate.push({
              ...
              accountID,
              name,
              count: day < 10 ? `00${day}` : day < 100 ? `0${day}` : `${day}`,
              date: format(nextDay, "MM/dd/yyyy"),
  ...
  const handleConfirmSubmit = async () => {
    ...
    try {
      ...
      const loanRequestsCollectionRef = collection(userDocRef, "loanRequests");
        ...
        <ScrollView>
          <View style={{ paddingHorizontal: 40 }}>
            ...
            >
              ...
              <TouchableOpacity
                onPress={() => setShowEMICalculation(!showEMICalculation)}
              >
            ...
            {showEMICalculation && (
              <View>
                ...
                >
                  <View style={styles.cardItem}>
                    <View style={styles.contentWrapper}>
                      <Text style={styles.cardText}>Total Finance Charge</Text>
                      <Text style={styles.cardTextBold}>
                        ₱
                        {selectedLoans != "" &&
                          selectedTerms != "" &&
