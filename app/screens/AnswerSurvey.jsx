    ...
    <View style={{ flex: 1, justifyContent: "center", alignItems: "center" }}>
      ...
      <View style={{ marginHorizontal: 40, marginTop: 20 }}>
        ...
        <Text style={styles.submitText}>
          Thank you for submitting your feedback. Your input is valuable to us
          and will help us improve our services. Your feedback has been
          ...
          <View style={{ paddingHorizontal: 40 }}>
            <View style={{ marginBottom: 10 }}>
              ...
              <Text style={[styles.sectionSubText, { fontStyle: "italic" }]}>
                Please rate each statement and for each statement select your
                level of agreement from the dropdown menu.
              </Text>
            </View>
            <View style={{ marginBottom: 22 }}>
              ...
              <Text style={styles.sectionSubText}>
                ...
                web-based platform for requesting a loan through the Lending
                Management System.
              </Text>
              ...
              <View style={styles.sectionInputDropdown}>
                ...
                >
                  ...
                  <Picker.Item label="Strongly Agree" value="Strongly Agree" />
