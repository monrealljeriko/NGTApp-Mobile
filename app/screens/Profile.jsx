      ...
      <View style={styles.modalContainer}>
        ...
        <View style={{ margin: 20 }}>
          ...
          <Text style={styles.modalText}>
            The San Jose Public Market Vendor and Community Credit Cooperative
            is a financial institution established in April 2017, offering
            business loans known as productive and emergency loans to help
            improve borrowers' businesses,
          </Text>
        </View>
      </View>
    </Modal>
      ...
      <View style={styles.headerContainerProfile}>
        <View style={styles.headerProfile}>
          <View style={{ flexDirection: "row" }}>
            <Image
              source={require("../../assets/icons/icon-profile-white.png")}
