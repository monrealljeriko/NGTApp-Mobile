    ...
    <View>
      ...
      <View style={{ marginBottom: 12 }}>
        <View style={styles.sectionInput}>
          <TextInput
            ...
            placeholderTextColor={COLORS.gray}
            style={styles.sectionInputText}
            onChangeText={(text) => handleInput(text, "completedEducation")}
          ...
          <View style={{ marginBottom: 12 }}>
            <View style={styles.sectionInput}>
              <TextInput
                ...
                placeholderTextColor={COLORS.gray}
                style={styles.sectionInputText}
                onChangeText={(text) => handleInput(text, "otherIDname")}
          ...
          <View style={{ marginBottom: 12 }}>
            <View style={styles.sectionInput}>
              <TextInput
                ...
                placeholderTextColor={COLORS.gray}
                style={styles.sectionInputText}
                onChangeText={(text) => handleInput(text, "otherIDnumber")}
        ...
        <View style={{ marginBottom: 12 }}>
          <View style={styles.sectionInput}>
            <TextInput
              ...
              maxLength={2}
              style={styles.sectionInputText}
              onChangeText={(text) => handleInput(text, "dependenciesCount")}
        ...
        <View style={{ marginBottom: 12 }}>
          <View style={styles.sectionInput}>
            <TextInput
              ...
              maxLength={3}
              style={styles.sectionInputText}
              onChangeText={(text) => handleInput(text, "dependenciesAges")}
      ...
      <View style={{ marginBottom: 12 }}>
        <View style={styles.sectionInputDropdown}>
          <Picker
            ...
            onValueChange={(itemValue) => handleInput(itemValue, "addressType")}
          ...
          <View style={{ marginTop: 12 }}>
            <View style={styles.sectionInput}>
              <TextInput
                ...
                placeholderTextColor={COLORS.gray}
                style={styles.sectionInputText}
                onChangeText={(text) => handleInput(text, "addressOtherType")}
      ...
      <View style={{ marginBottom: 12 }}>
        <View style={styles.sectionInput}>
          <TextInput
            ...
            placeholderTextColor={COLORS.gray}
            style={styles.sectionInputText}
            onChangeText={(text) => handleInput(text, "provincialAddress")}
      ...
      <View>
        <View style={{ flexDirection: "row" }}>
          ...
          <TouchableOpacity onPress={() => handleInput("Yes", "vehicleSelect")}>
            <View style={styles.sectionOption}>
          ...
          <TouchableOpacity onPress={() => handleInput("No", "vehicleSelect")}>
            <View style={styles.sectionOption}>
          ...
          <View style={{ marginBottom: 12 }}>
            <View style={styles.sectionInput}>
              <TextInput
                ...
                placeholderTextColor={COLORS.gray}
                style={styles.sectionInputText}
                onChangeText={(text) => handleInput(text, "vehicleType")}
          ...
          <View style={{ marginBottom: 12 }}>
            <View style={styles.sectionInput}>
              <TextInput
                ...
                style={styles.sectionInputText}
                maxLength={12}
                onChangeText={(text) => handleInput(text, "vehiclePlateNumber")}
