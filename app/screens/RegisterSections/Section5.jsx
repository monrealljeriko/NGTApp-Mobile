      ...
      <View style={{ marginBottom: 12 }}>
        ...
        <View style={styles.sectionReview}>
          <TouchableOpacity onPress={() => toggleInformation(0)}>
            <View style={styles.clickableReview}>
            ...
            <View>
              <View style={styles.sectionContainer}>
                ...
                <Text style={styles.customSubtextData}>
                  {section1Obj.lastName == "" ? "n/a" : section1Obj.lastName}
                </Text>
              </View>
              <View style={styles.sectionContainer}>
                <Text style={styles.customSubtext}>First name :</Text>
                <Text style={styles.customSubtextData}>
                  {section1Obj.firstName == "" ? "n/a" : section1Obj.firstName}
                </Text>
              </View>
              <View style={styles.sectionContainer}>
              ...
              <View style={styles.sectionContainer}>
                <Text style={[styles.customSubtextData, { paddingLeft: 40 }]}>
          ...
          {showOther && (
            <View>
              ...
              {section1Obj.vehicleSelect == "Yes" && (
                <View>
                  <View style={styles.sectionContainer}>
                    <Text style={styles.customSubtext}>Vehicle Type :</Text>
                    <Text style={styles.customSubtextData}>
                  ...
                  <View style={styles.sectionContainer}>
                    <Text style={styles.customSubtext}>Plate Number :</Text>
                    <Text style={styles.customSubtextData}>
        ...
        <View style={styles.sectionReview}>
          ...
          {showEmployment && (
            <View>
              ...
              <View style={styles.sectionContainer}>
                <Text style={styles.customSubtext}>Length of Service :</Text>
                <Text style={styles.customSubtextData}>
              ...
              <View style={styles.sectionContainer}>
                <Text style={styles.customSubtext}>Employment Status :</Text>
                <Text style={styles.customSubtextData}>
      ...
      <View style={{ marginBottom: 12 }}>
        <View style={styles.sectionReview}>
          <TouchableOpacity onPress={() => toggleInformation(5)}>
            <View style={styles.clickableReview}>
              <Text style={styles.sectionSubtext}>Spouse's Information</Text>
              <Ionicons
                name={
          ...
          {showReference && (
            <View>
              ...
              <View style={[styles.sectionContainer, { marginTop: 18 }]}>
                ...
                <Text style={[styles.customSubtextData, ,]}>
                  {section4Obj.heardFrom == "" ? "n/a" : section4Obj.heardFrom}
                </Text>
                <Text style={[styles.customSubtextData]}>
                  {section4Obj.heardFrom == "others" && section4Obj.others}
                </Text>
              </View>
              <Text style={[styles.customSubtextData]}>
                {section4Obj.heardFrom == "referred" && section4Obj.referredBy}
              </Text>
            </View>
          )}
        </View>
